...
<center><h1 style="background-color:#52b848; color:#161616">General Stock ReOrder Form</h1>
...
<form action="php_for.php" class = "ordering">
<?php
    //open database to display values for general stock reordering in an html table
